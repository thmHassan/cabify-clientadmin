...
export const CREATE_RIDE_COUNT = "/company/save-ride-count";
export const EDIT_RIDE_COUNT = "/company/edit-ride-count";
export const DELETE_RIDE_COUNT = "/company/delete-ride-count";
