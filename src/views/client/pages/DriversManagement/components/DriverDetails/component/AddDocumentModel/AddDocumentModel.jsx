                    ...
                    return (
                        <div className="w-[500px] max-w-full">
                            <Form>
                                ...
                                <div className="mb-6">
                                    {/* Document Name - Only show if document_name exists */}
                                    {values.documentName && (
                                    ...
                                    {/* Issue Date - Only show if has_issue_date exists */}
                                    {values.issueDate && (
                                        <div className="w-full mb-4">
                                    ...
                                    {/* Expiry Date - Only show if has_expiry_date exists */}
                                    {values.expiryDate && (
                                        <div className="w-full mb-4">
                                    ...
                                    {/* Number Field - Only show if has_number_field exists */}
                                    {values.numberField && (
                                        <div className="w-full mb-4">
                                    ...
                                    {/* Photos Section - Only show photos that exist */}
                                        ...
                                        <div className="flex flex-col gap-4 mt-4">
                                            {values.frontPhoto && (
                                                <div className="w-full">
                                                    ...
                                                    <div className="w-full border border-gray-300 rounded-lg overflow-hidden bg-gray-100">
                                                        <img
                                                            src={appConfig.getAssetUrl(values.frontPhoto)}
                                            ...
                                            {values.backPhoto && (
                                                <div className="w-full">
                                                    ...
                                                    <div className="w-full border border-gray-300 rounded-lg overflow-hidden bg-gray-100">
                                                        <img
                                                            src={appConfig.getAssetUrl(values.backPhoto)}
                                                            className="w-full h-48 object-cover"
                                                            alt="Back"
                                                        />
                                                    </div>
                                            ...
                                            {values.profilePhoto && (
                                                <div className="w-full">
                                                    ...
                                                    <div className="w-full border border-gray-300 rounded-lg overflow-hidden bg-gray-100">
                                                        <img
                                                            src={appConfig.getAssetUrl(values.profilePhoto)}
                                                            className="w-full h-48 object-cover"
                                                            alt="Profile"
                                                        />
                                                    </div>
