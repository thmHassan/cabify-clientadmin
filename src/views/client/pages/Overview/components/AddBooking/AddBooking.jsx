                                                    ...
                                                    <div className="flex md:flex-row flex-col">
                                                        ...
                                                        <div className="border mt-2 max-sm:w-full rounded-lg h-28 md:mt-0 px-4 py-4 bg-white shadow-sm">
                                                            <div className="flex flex-col gap-3">
                                                                <label className={`flex items-center gap-2 ${shouldDisableDispatchOptions(values) || !!values.driver ? 'opacity-50 cursor-not-allowed' : ''}`}>
                                                                    <input
                                                                        type="checkbox"
...
//         // Driver selected - manual dispatch
//         setFieldValue("auto_dispatch", false);
//         setFieldValue("bidding", false);
//         setFieldValue("booking_system", "manual_dispatch");
...
//         if (assignedVehicleId) {
//             // ✅ assigned_vehicle chhe - sirf te j vehicle show karo
//             const filtered = vehicleList.filter(v => v.value === assignedVehicleId.toString());
//             setFilteredVehicleList(filtered.length > 0 ? filtered : vehicleList);
...
//             }
//         } else {
//             // ✅ assigned_vehicle null - badha vehicles show karo
//             setFilteredVehicleList(vehicleList);
//             if (vehicleTypeId) {
//                 // vehicle_type match vehicle auto-select
//                 const matched = vehicleList.find(v => v.value === vehicleTypeId.toString());
//                 if (matched) {
//                     setFieldValue("vehicle", matched.value);
//                     invalidateFare();
//                 } else {
//                     setFieldValue("vehicle", "");
//                 }
...
//                                                                             className={`border-[1.5px] shadow-lg rounded-[8px] px-3 py-2 w-full md:w-full ${bookingErrors.phone_no ? 'border-red-500' : 'border-[#8D8D8D]'}`}
//                                                                             value={values.phone_no || ""}
//                                                                             onChange={(e) => { setFieldValue("phone_no", e.target.value); clearBookingError("phone_no"); }}
//                                                                         />
//                                                                     </div>
//                                                                     <div className="ml-20 md:ml-28">
