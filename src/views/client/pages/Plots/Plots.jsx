...
//   const leafletMapRef = useRef(null);
//   const leafletPolygonRef = useRef(null);
//   const barikoiTileFailedRef = useRef(false);
//   const [mapsReady, setMapsReady] = useState(false);
//   const [leafletReady, setLeafletReady] = useState(false);
//   const [mapProvider, setMapProvider] = useState("google");
//   const [googleApiKey, setGoogleApiKey] = useState("");
...
//     if (mapProvider === "google") {
//       setLeafletReady(false);
//       barikoiTileFailedRef.current = false;
//       loadGoogleMaps(googleApiKey);
//     } else if (mapProvider === "barikoi") {
//       setMapsReady(false);
//       barikoiTileFailedRef.current = false;
...
//         // If the Barikoi key is invalid/unauthorized, fall back to OpenStreetMap tiles
//         tileLayer.on("tileerror", () => {
//           if (barikoiTileFailedRef.current) return;
//           barikoiTileFailedRef.current = true;

//           // If we have a Google key, switch provider to Google for a better experience
//           if (googleApiKey) {
//             setMapProvider("google");
//             return;
//           }

//           // Otherwise fall back to OpenStreetMap tiles to keep the map visible
//           if (!leafletMapRef.current) return;
//           tileLayer.off("tileerror");
//           leafletMapRef.current.removeLayer(tileLayer);
//           window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
