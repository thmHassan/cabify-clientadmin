        ...
        >
            <div className="flex items-center gap-3">
                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-gray-100 text-left whitespace-nowrap">
                    ...
                    <p className="text-black text-center font-semibold text-sm">{rating.id}</p>
                </div>
            </div>
            <div className="flex items-center justify-center gap-3">
                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-gray-100 text-left whitespace-nowrap">
                    <p className="text-xs text-center text-gray-500">User Name</p>
                    <p className="text-black text-center font-semibold text-sm">{rating?.booking_detail?.user_detail?.name}</p>
                </div>

                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-gray-100 text-left whitespace-nowrap">
                    <p className="text-xs text-center text-gray-500">Driver Name</p>
                    <p className="text-black text-center font-semibold text-sm">{rating?.booking_detail?.driver_detail?.name}</p>
                </div>
                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-gray-100 text-left whitespace-nowrap">
                    <p className="text-xs text-center text-gray-500">Driver Rating</p>
                    <p className="text-black text-center font-semibold text-sm">{rating.rating}</p>
                </div>
                <div className="inline-flex w-80 flex-col px-4 py-2 rounded-full bg-gray-100 text-left break-all">
                    ...
                    <p className="text-black font-semibold text-[12px]">{rating.comment}</p>
                </div>
            </div>
        </div>
    );
