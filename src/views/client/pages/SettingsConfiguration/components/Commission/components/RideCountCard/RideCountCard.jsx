        ...
        <div className="bg-white rounded-[15px] p-4 gap-2 flex items-center justify-between hover:shadow-md overflow-x-auto">
            <div className="flex items-center gap-3">
                <div className="w-auto">
                    <p className="font-semibold text-xl">#{commission.id}</p>
                </div>
            </div>

            <div className="flex items-center justify-end gap-3">
                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-[#EFEFEF] text-left whitespace-nowrap w-[170px]">
                    <p className="text-xs text-center text-[#6C6C6C]">Ride Count</p>
                    <p className="text-[#333333] text-center font-semibold text-sm">{commission.package_ride_count} Rides</p>
                </div>

                <div className="inline-flex flex-col px-4 py-2 rounded-full bg-[#EFEFEF] text-left whitespace-nowrap w-[170px]">
                    <p className="text-xs text-center text-[#6C6C6C]">Price</p>
                    <p className="text-[#333333] text-center font-semibold text-sm"> {currencySymbol} {commission.package_amount}</p>
                </div>
